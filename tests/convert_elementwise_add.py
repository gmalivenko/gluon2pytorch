...
class ElementwiseAddTest(mx.gluon.nn.HybridSequential):
    def __init__(self):
        super(ElementwiseAddTest, self).__init__()
...
if __name__ == '__main__':
    print('Test elementwise addition:')

    net = ElementwiseAddTest()

    # Make sure it's hybrid and initialized
    net.hybridize()
    net.collect_params().initialize()

    pytorch_model = gluon2pytorch(net, [(1, 3, 224, 224)], dst_dir=None, pytorch_module_name='ElementwiseAddTest')
